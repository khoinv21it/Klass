...
export default function Form02() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100 px-4">
      <div className="w-full max-w-5xl bg-white rounded-xl shadow-lg overflow-hidden flex flex-col lg:flex-row">
        {/* Left Panel - narrow */}
        <div className="hidden lg:flex w-full lg:w-1/3 bg-[#0066FF] text-white flex-col justify-center items-center p-12 text-center">
        ...
        <div className="w-full lg:w-2/3 p-12">
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <input
                  ...
                  className="w-full border border-gray-300 py-3 px-4 rounded-md"
                />
                {errors.firstName && (
            ...
            <button
              type="submit"
              className="w-full bg-blue-600 hover:bg-blue-700 text-white py-3 rounded-md font-medium text-base disabled:opacity-50 disabled:cursor-not-allowed"
              disabled={!isValid}
            >
              Create Account
            </button>
