...
import { login } from "../dashboard/services";
...
export default function LoginPage() {
  ...
  const onSubmit: SubmitHandler<IFormInput> = async (data) => {
    ...
    Cookies.set("user", JSON.stringify(authenticatedUser), { expires: 0.5 });
    // save access token to cookie
    Cookies.set("access_token", result.access_token, { expires: 0.5 });
